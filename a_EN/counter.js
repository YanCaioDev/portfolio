...
document.getElementById('anos').textContent = diferenca.anos + " years";
document.getElementById('meses').textContent = diferenca.meses + " months";
document.getElementById('dias').textContent = diferenca.dias + " days";